...
export function LogTests<F extends (...p: any[]) => unknown>(title: string, fct: F, fName: string, assertions: Assertion<Parameters<typeof fct>, ReturnType<typeof fct>>[], root?: Element): void {
